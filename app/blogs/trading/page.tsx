...
export default function TradingPage() {
    const blogs = getBlogsByCategory("trading");
    const categoryData = blogCategories.trading;
                ...
                >
                    {blogs.length > 0 ? (
                        ...
                        <div className="text-center py-20">
                            <p className="text-white/60 text-xl">More trading articles coming soon...</p>
                        </div>
                    )}
                </motion.div>
            </section>
            ...
            <section className="py-32 px-4 md:px-8 max-w-[1800px] mx-auto">
                ...
                >
                    ...
                    <p className="text-xl text-white/70 mb-8">
                        Explore our project management insights
                    </p>
                    <Link href="/blogs/project-management">
                        <motion.button
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            className="px-8 py-4 bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-semibold rounded-lg hover:shadow-lg hover:shadow-blue-500/50 transition-all duration-300"
                        >
                            View Project Management Articles
                        </motion.button>
                    </Link>
                </motion.div>
            </section>
